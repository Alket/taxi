...
export function serializeSettings(
  ...
  return {
    ...
    pokMode: row.pokMode === "live" ? "live" : "test",
    pokStagingKeyId: row.pokStagingKeyId ?? "",
    pokStagingMerchantId: row.pokStagingMerchantId ?? "",
    pokStagingKeySecretSet: Boolean(row.pokStagingKeySecret),
    pokLiveKeyId: row.pokLiveKeyId ?? "",
    pokLiveMerchantId: row.pokLiveMerchantId ?? "",
    pokLiveKeySecretSet: Boolean(row.pokLiveKeySecret),
